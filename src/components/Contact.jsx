...
const Contact = () => {
  return (
    <div
      className="mt-16 flex flex-col min-h-screen  justify-center items-center gap-16"
      id="contact"
    >
      ...
      <div className=" w-fit justify-center mx-auto flex gap-10 flex-wrap ">
        <SocialMedia
          social="/tel.png"
          name="Telephone"
          contact="261 32 57 637 96 "
        />
        <SocialMedia
          social="/email.png"
          name="Email"
          contact="ando.nirina.pro@gmail.com "
        />
        <SocialMedia
          social="/location.png"
          name="Address"
        ...
        <SocialMedia
          social="/linkedin.png"
          name="Linkedin"
          contact="www.linkedin.com/in/ando-nirina"
        />
      </div>
